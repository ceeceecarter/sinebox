    ...
    var getPoster = function(){
         ...
         var film = $('#term').val();
          ...
          if(film == ''){
             ...
             $.getJSON("http://api.themoviedb.org/2.1/Movie.search/en/json/e8b294389a11aab6804771453517783c/" + film + "?callback=?", function(json) {
                if (json != "Nothing found."){
                      ...
                      $.getJSON("http://api.themoviedb.org/2.1/Movie.search/en/json/e8b294389a11aab6804771453517783c/goonies?callback=?", function(json) {
                         console.log(json);
